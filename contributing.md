# Contributing to generator-esites-fe
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/generator-esites-fe
   # Navigate to the newly cloned directory
   cd generator-esites-fe
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/e-sites/generator-esites-fe.git
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   message conventions](https://github.com/erlang/otp/wiki/writing-good-commit-messages)
